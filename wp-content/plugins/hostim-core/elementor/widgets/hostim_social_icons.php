 ...
 * @since 1.0.0
 */
class Hostim_social_icons extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Hostim Social Icons', 'hostim-core' );
	}
	...
	public function get_keywords() {
		return [ 'social', 'icon', 'link', 'hostim' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_social_icon',
			[
				'label' => esc_html__( 'Social Icons', 'hostim-core' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => 'default',
				'options' => [
					'default' => esc_html__( 'Official Color', 'hostim-core' ),
					'custom' => esc_html__( 'Custom', 'hostim-core' ),
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Primary Color', 'hostim-core' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Secondary Color', 'hostim-core' ),
				'type' => Controls_Manager::COLOR,
				'condition' => [
					'item_icon_color' => 'custom',
				],
		...
		$this->add_control(
			'shape',
			[
				'label' => esc_html__( 'Shape', 'hostim-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'rounded',
				'options' => [
					'rounded' => esc_html__( 'Rounded', 'hostim-core' ),
					'square' => esc_html__( 'Square', 'hostim-core' ),
					'circle' => esc_html__( 'Circle', 'hostim-core' ),
				],
		...
		$this->add_responsive_control(
			'columns',
			[
				'label' => esc_html__( 'Columns', 'hostim-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => '0',
				'options' => [
					'0' => esc_html__( 'Auto', 'hostim-core' ),
					'1' => '1',
					'2' => '2',
					'3' => '3',
					'4' => '4',
		...
		$this->add_control(
			'view',
			[
				'label' => esc_html__( 'View', 'hostim-core' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-social-icon' => 'background: linear-gradient( 95.45deg, {{icon_primary_color.VALUE}}, {{VALUE}} );',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .hostim-icon i' => 'font-size: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			'row_gap',
			[
				'label' => esc_html__( 'Rows Gap', 'hostim-core' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Icon Hover', 'hostim-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
